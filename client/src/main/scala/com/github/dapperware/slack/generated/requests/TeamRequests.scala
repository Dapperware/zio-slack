 ...
 */
case class AccessLogsTeamRequest(
 ...
 */
case class BillableInfoTeamRequest(user: Option[String] = None)
 ...
 */
case class InfoTeamRequest(team: Option[String] = None)
...
case class IntegrationLogsTeamRequest(
  ...
  change_type: Option[String] = None,
  count: Option[String] = None,
  page: Option[String] = None,
